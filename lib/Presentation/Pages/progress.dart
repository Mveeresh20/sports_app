      ...
      body: Column(
        children: [
          Padding(
            ...
            SizedBox(height: 28),
            Center(child: Text("Select Date",style: TextStyle(fontFamily: "Inter",fontSize: 16,fontWeight: FontWeight.w500,color: Color(0xFF7B8A99)),)),
            SizedBox(height: 10),
            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [Color(0xFFF23943),Color(0xFFC1232C)])
                ),
