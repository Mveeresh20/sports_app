...
class _SportsCategoryViewState extends State<SportsCategoryView> {
  ...
  Widget _buildSelectedCategory(String sport) {
    return Container(
     decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(32),
          gradient: LinearGradient(colors: [Color(0xFFF23943),Color(0xFFC1232C)]), // Styling for selected
                border: Border.all(
    ...
    return Wrap(
      ...
      children: _sports.map((sport) {
        ...
        return GestureDetector(
          ...
          child: isSelected ? _buildSelectedCategory(sport) : _buildUnselectedCategory(sport),
        );
      }).toList(),
    );
  }
